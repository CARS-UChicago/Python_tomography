...
def preprocess_13bm_MSU_bad(fname, dark_value=None, zinger_threshold=0.2, zinger_filter_size=3):
  logging.basicConfig(
  ...
  # Accidentally collected 3600 projections over 360 degrees.
  # Throw away last 1800 since tomoDisplay assumes 180 degrees
  proj = proj[:1800,:,:]
...
if __name__ == "__main__":
  ...
  preprocess_13bm_MSU_bad(args.filename, args.dark_value,
