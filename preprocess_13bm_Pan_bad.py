...
def preprocess_13bm_Pan_bad(fname, dark_value=None, zinger_threshold=0.2, zinger_filter_size=3):
  logging.basicConfig(
  ...
  # The proj size is wrong
  proj = proj[:3600,:,:]
  for a in range(3575,3600):
    proj[a,:,:] = proj[3574,:,:]
...
if __name__ == "__main__":
  ...
  preprocess_13bm_Pan_bad(args.filename, args.dark_value,
